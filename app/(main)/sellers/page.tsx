            ...
            <div className="container px-4 mx-auto relative z-10 max-w-7xl">
                ...
                <div className="space-y-8 mb-20">
                    <div className="space-y-4">
                        ...
                        <h1 className="text-5xl md:text-7xl font-black uppercase tracking-tighter italic font-heading leading-none">
                            Authorized <span className="text-white/40">Sellers.</span>
                        </h1>
                        <p className="text-white/60 text-lg font-medium leading-relaxed italic max-w-2xl">
                            Connect with <span className="text-white">verified campus entrepreneurs and sellers</span> across the Abuja network. Trusted by the System.
                        </p>
                    </div>
                    ...
                    <div className="glass-card p-4 rounded-3xl border-white/5 bg-zinc-900/40 backdrop-blur-xl flex flex-col md:flex-row gap-4">
                        <div className="relative flex-1">
                            ...
                            <Input
                                ...
                                className="pl-12 bg-white/5 border-white/10 rounded-2xl h-14 uppercase text-[10px] font-black tracking-widest placeholder:text-white/30 focus-visible:ring-[#FF6200]/50"
                                value={searchTerm}
                        ...
                        <Select value={storeTypeFilter} onValueChange={setStoreTypeFilter}>
                            <SelectTrigger className="w-full md:w-56 bg-white/5 border-white/10 rounded-2xl h-14 uppercase text-[10px] font-black tracking-widest text-white/60">
                                <SelectValue placeholder="Campus Type" />
                            </SelectTrigger>
                            <SelectContent className="bg-zinc-900 border-white/10">
                                <SelectItem value="all" className="text-[10px] font-black uppercase tracking-widest">All Campuss</SelectItem>
                ...
                {loading && (
                    <div className="text-center py-48">
                        ...
                        <p className="text-[10px] font-black uppercase tracking-widest text-white/30">Scanning Seller Network...</p>
                    </div>
                )}
                                ...
                                <CardHeader className="p-8 pb-4">
                                    <div className="flex justify-between items-start mb-6">
                                        <div className="h-14 w-14 rounded-2xl bg-white/5 border border-white/10 flex items-center justify-center group-hover:border-[#FF6200]/50 transition-colors">
                                            <Building className="h-6 w-6 text-white/40 group-hover:text-[#FF6200]" />
                                        </div>
                                        <div className="bg-white/5 border border-white/10 px-3 py-1.5 rounded-lg flex items-center gap-2">
                                            ...
                                            <span className="text-[8px] font-black uppercase tracking-widest text-white/60">{seller.store_type || 'Digital'}</span>
                                        </div>
                                    </div>
                                    <div className="space-y-2">
                                        ...
                                        <div className="flex items-center gap-2 text-[10px] font-black text-white/30 uppercase tracking-widest italic font-heading">
                                ...
                                <CardContent className="p-8 pt-0 space-y-6">
                                    ...
                                    <div className="flex items-center justify-between pt-6 border-t border-white/5">
                                        <div className="flex items-center gap-1.5">
                                            ...
                                            <span className="text-[10px] font-black text-white/30 uppercase tracking-widest">(New)</span>
                                        </div>
                                ...
                                <CardFooter className="p-8 pt-0">
                                    <Button className="w-full h-14 bg-white/5 border border-white/10 hover:bg-[#FF6200] hover:text-black rounded-2xl uppercase text-[10px] font-black tracking-[0.2em] transition-all group/btn font-heading italic" asChild>
                                        <Link href={`/seller/${seller.id}`} className="flex items-center justify-center gap-2">
                                            Access Campus <ArrowUpRight className="h-3 w-3 group-hover/btn:translate-x-0.5 group-hover/btn:-translate-y-0.5 transition-transform" />
                                        </Link>
                                    </Button>
                                </CardFooter>
                            </Card>
                ...
                {!loading && filteredSellers.length === 0 && (
                    <div className="text-center py-48 glass-card rounded-[3.5rem] border-dashed border-white/5">
                        <Search className="h-16 w-16 text-white/10 mx-auto mb-8 opacity-20" />
                        <h3 className="text-xl font-black text-white/40 uppercase tracking-[0.2em] font-heading mb-2">No Matching Campuss</h3>
                        <p className="text-white/30 text-sm font-medium lowercase italic">Adjust frequency and retry Dashboard scan.</p>
                    </div>
                )}
            </div>
        </div>
