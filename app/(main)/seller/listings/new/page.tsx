...
${formData.description}`;
    ...
    return (
        <div className="min-h-screen bg-[#FAFAFA] text-zinc-900 relative selection:bg-[#FF6200] selection:text-black pt-32 pb-24">
            {/* Background Grid */}
                            ...
                            <div className="space-y-3">
                                ...
                                <div className="relative group">
                                    ...
                                    <Input
                                        ...
                                        placeholder="0.00"
                                        className="h-16 pl-16 rounded-2xl bg-[#FAFAFA]/40 border-zinc-100 focus:border-[#FF6200] focus:ring-1 focus:ring-[#FF6200] transition-all text-2xl font-black font-heading"
                                        required
                                    />
                                </div>
                            </div>
