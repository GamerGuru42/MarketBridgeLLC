...
function DisputeCard({ dispute, onView }: { dispute: Dispute, onView: () => void }) {
    ...
    return (
        <div className="group glass-card p-6 flex flex-col md:flex-row gap-6 items-center border border-white/5 hover:border-[#FF6200]/30 transition-all bg-white/[0.02]">
            ...
            <Button onClick={onView} variant="outline" className="border-white/10 hover:bg-[#FF6200] hover:text-black hover:border-transparent transition-all font-black uppercase tracking-widest text-[10px] h-12 px-6 rounded-xl font-heading">
                Open Dossier
            </Button>
        </div>
    );
