...
import { Loader2, CheckCircle, AlertTriangle, Building, Banknote } from 'lucide-react';
                                        ...
                                        <div key={order.id} className="bg-black border border-white/10 rounded-2xl p-6 flex flex-col md:flex-row gap-6 items-start md:items-center justify-between group hover:border-[#FF6600]/30 transition-colors">
                                            ...
                                            <div className="flex flex-col items-end gap-4 min-w-[150px]">
                                                <div className="text-right">
                                                    ...
                                                    <span className="text-2xl font-black text-[#00FF85] tracking-tight">₦{order.seller_receives.toLocaleString()}</span>
                                                </div>
