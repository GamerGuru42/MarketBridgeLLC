...
import { CheckCircle, XCircle, Loader2, RefreshCw, Play, ArrowRight, ShieldCheck } from 'lucide-react';
                ...
                <div className="flex justify-between items-end mb-12 border-b border-white/10 pb-6">
                    <div>
                        ...
                        <h1 className="text-4xl md:text-5xl font-black uppercase tracking-tighter italic font-heading">
                            Sub <span className="text-[#00FF85]">Verification</span>
                        </h1>
                    </div>
                    <Button onClick={fetchPendingVerifications} variant="ghost" size="sm" className="text-zinc-500 hover:text-[#00FF85] hover:bg-[#00FF85]/10 font-mono text-xs uppercase tracking-widest border border-white/10">
                ...
                {loading ? (
                    ...
                    <div className="grid grid-cols-1 gap-6">
                        {verifications.map((verification) => (
                            <div key={verification.id} className="group relative bg-zinc-950/50 backdrop-blur-md border border-white/10 p-8 rounded-2xl overflow-hidden hover:border-[#00FF85]/30 transition-all duration-300">
                                <div className="absolute top-0 left-0 w-1 h-full bg-gradient-to-b from-[#00FF85] to-transparent opacity-0 group-hover:opacity-100 transition-opacity" />
                                ...
                                <div className="flex flex-col lg:flex-row justify-between gap-8">
                                    <div className="space-y-6 flex-1">
                                        ...
                                        <div className="grid grid-cols-2 lg:grid-cols-4 gap-6 bg-white/5 rounded-xl p-6 border border-white/5">
                                            ...
                                            <div>
                                                ...
                                                <p className="text-xl font-black text-[#00FF85] font-heading">
                                    ...
                                    <div className="flex flex-col gap-3 justify-center min-w-[200px] border-l border-white/10 pl-8 border-dashed lg:border-solid border-l-0 lg:border-l lg:pl-8 pt-6 lg:pt-0 lg:border-t-0 border-t">
                                        <Button
                                            ...
                                            className="bg-[#00FF85] hover:bg-[#00CC6A] text-black font-black uppercase tracking-widest text-xs h-12"
                                        >
                                        ...
                                        <Button
                                            ...
                                            disabled={!!actionLoading}
                                            variant="ghost"
                                            className="text-red-500 hover:text-red-400 hover:bg-red-500/10 font-mono uppercase tracking-widest text-xs h-12 border border-red-500/20"
                                        >
