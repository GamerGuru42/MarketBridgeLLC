    ...
    return (
        <div className="min-h-screen flex items-center justify-center p-4 bg-black font-sans relative overflow-hidden">
            ...
            <div className="fixed inset-0 pointer-events-none z-0">
                <div className="absolute top-0 right-0 w-[500px] h-[500px] bg-[#FF6200]/10 rounded-full blur-[120px] opacity-20" />
            ...
            <div className="max-w-md w-full text-center space-y-8 relative z-10">
                ...
                <div className="relative mx-auto h-40 w-40 flex items-center justify-center group">
                    <div className="absolute inset-0 bg-[#FF6200]/10 rounded-full animate-pulse group-hover:bg-[#FF6200]/20 transition-all duration-500"></div>
                    <div className="absolute inset-0 border border-[#FF6200]/20 rounded-full scale-110 opacity-0 group-hover:scale-125 group-hover:opacity-100 transition-all duration-700"></div>
                    <div className="relative h-28 w-28 bg-black border border-white/10 rounded-full flex items-center justify-center shadow-[0_0_30px_rgba(255,184,0,0.1)]">
                        <Search className="h-12 w-12 text-[#FF6200]" />
                    </div>
                </div>
                ...
                <div className="space-y-4">
                    ...
                    <h2 className="text-xl font-black uppercase tracking-[0.2em] text-[#FF6200]">
                        Signal Lost
                    </h2>
                    <p className="text-zinc-500 text-sm max-w-[280px] mx-auto leading-relaxed border-l-2 border-[#FF6200]/50 pl-4 text-left">
                ...
                <div className="pt-8 grid grid-cols-2 gap-4">
                    <Button
                        variant="outline"
                        onClick={() => router.back()}
                        className="h-14 font-bold uppercase tracking-widest text-xs border-white/10 text-white hover:bg-white/5 hover:border-[#FF6200]/50"
                    >
                    ...
                    <Button
                        asChild
                        className="h-14 font-bold uppercase tracking-widest text-xs bg-[#FF6200] text-black hover:bg-[#FF6200] hover:scale-105 transition-all shadow-[0_0_20px_rgba(255,184,0,0.3)]"
                    >
                        <Link href="/">
