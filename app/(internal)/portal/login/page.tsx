                        ...
                        {departments.map((d, i) => (
                            <div key={i} className="bg-secondary border border-border rounded-[2.5rem] p-6 flex flex-col items-center text-center group hover:border-primary/50 transition-all">
                                ...
                                <Button 
                                    ...
                                    disabled={isLoading}
                                    className="w-full h-14 bg-primary text-primary-foreground font-black uppercase text-[10px] tracking-widest rounded-2xl flex items-center justify-center gap-3 relative overflow-hidden group/btn hover:bg-primary/90 transition-all border-none"
                                >
                                    {isLoading ? <Loader2 className="h-5 w-5 animate-spin" /> : (
                                        <div className="flex items-center justify-center gap-3 px-4">
                                            <div className="h-7 w-7 bg-white rounded-lg flex items-center justify-center shrink-0 shadow-sm">
                                            ...
                                            <span className="leading-none mt-0.5">Sign In with Google</span>
                                        </div>
                                    )}
                                </Button>
                            </div>
