                        ...
                        {departments.map((d, i) => (
                            <div key={i} className="bg-secondary border border-border rounded-[2.5rem] p-6 flex flex-col items-center text-center group hover:border-primary/50 transition-all">
                                ...
                                <Button 
                                    ...
                                    disabled={isLoading}
                                    className="w-full h-12 bg-primary text-primary-foreground font-black uppercase text-[9px] tracking-widest rounded-xl flex items-center justify-center gap-2"
                                >
