...
import { Loader2, Check, ArrowLeft, Mail, Globe, Eye, EyeOff, ShieldCheck, User as UserIcon, Briefcase, Zap, Crown } from 'lucide-react';
                ...
                <div className="w-full max-w-5xl relative z-10">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 px-4">
                        {[
                            ...
                            { id: 'ceo', title: 'CEO', icon: Crown, desc: 'Vision Command Hub', color: 'text-amber-500' }
                        ].map(item => (
                            <Card
                                key={item.id}
