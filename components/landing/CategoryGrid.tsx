        ...
        <section className="py-24 bg-black relative">
            <div className="container px-4 mx-auto">
                <div className="flex justify-between items-end mb-12">
                    <div>
                        <h2 className="text-4xl md:text-5xl font-black text-white tracking-tighter uppercase mb-4">
                            Explore <span className="text-[#FF6200]">Campus</span>
                        </h2>
                            ...
                            <motion.div variants={item} key={idx}>
                                ...
                                >
                                    <div className={cn(
                                        ...
                                        cat.locked ? "opacity-50 cursor-not-allowed" : "hover:bg-[#FF6200] hover:border-[#FF6200] cursor-pointer"
                                    )}>
                                        <div className={cn(
                ...
                <div className="mt-8 text-center md:hidden">
                    <Link href="/listings" className="inline-flex items-center gap-2 text-[#FF6200] font-bold hover:text-white transition-colors">
                        View All Categories
