...
const items = [
    { icon: Smartphone, label: 'MacBook Pro M3', price: 'Γéª2.1M', rotation: -6, color: 'bg-zinc-800' },
    { icon: Shirt, label: 'Nike Dunk Low', price: 'Γéª45k', rotation: 12, color: 'bg-zinc-900' },
    { icon: Headphones, label: 'Sony XM5', price: 'Γéª350k', rotation: -3, color: 'bg-black' },
    { icon: Book, label: 'Medical Anatomy', price: 'Γéª12k', rotation: 8, color: 'bg-zinc-800' },
];
