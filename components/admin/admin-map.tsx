    ...
    return (
        <div className="relative w-full h-[400px] bg-black/40 rounded-[3rem] border border-white/5 overflow-hidden group">
            ...
            <div className="absolute top-8 left-8 z-10">
                <h3 className="text-[10px] font-black uppercase tracking-[0.4em] text-primary italic mb-2">Activity Monitoring</h3>
                <p className="text-[20px] font-black uppercase tracking-tighter text-white italic font-heading">Active Regions</p>
            </div>
            ...
            <div className="absolute top-8 right-8 z-10 flex items-center gap-4 bg-black/60 backdrop-blur-xl border border-white/5 px-4 py-2 rounded-full">
                ...
                <span className="text-[9px] font-black uppercase tracking-widest text-white/60">Live Data Connection</span>
            </div>

            <svg viewBox="0 0 100 100" className="w-full h-full p-12 opacity-40 group-hover:opacity-60 transition-opacity">
                {/* Nigeria Silhouette Path */}
                <path 
            ...
            <div className="absolute bottom-8 left-8 right-8 flex justify-between items-end z-10">
                <div className="space-y-1">
                    <p className="text-[8px] font-black uppercase tracking-widest text-white/30 italic">Primary Market</p>
                    <p className="text-[12px] font-black text-white/80 uppercase italic tracking-widest">Nigeria / Regional</p>
                </div>
                <div className="text-right space-y-1">
                    <p className="text-[8px] font-black uppercase tracking-widest text-white/30 italic">Coverage</p>
