    ...
    return (
        <AnimatePresence>
            {isVisible && (
                ...
                >
                    <div className="bg-zinc-900/90 backdrop-blur-xl border border-[#FF6600]/30 text-white py-2.5 px-4 rounded-full shadow-[0_8px_32px_rgba(0,0,0,0.4)] flex items-center gap-3 sm:gap-4 max-w-[90vw] sm:max-w-2xl pointer-events-auto">
