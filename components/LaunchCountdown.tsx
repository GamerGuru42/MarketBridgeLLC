    ...
    return (
        <div className="relative min-h-screen w-full bg-[#050505] text-white flex flex-col items-center justify-between overflow-hidden font-heading selection:bg-[#FF6200] selection:text-black py-10 md:py-16 px-6">
            ...
            <div className="relative z-10 w-full max-w-2xl flex flex-col md:flex-row items-center justify-center gap-6 md:gap-12 bg-white/[0.03] backdrop-blur-xl border border-white/5 rounded-[2rem] md:rounded-[2.5rem] p-6 md:p-10">
                <div className="flex flex-col items-center md:items-start text-center md:text-left gap-4 md:gap-6">
                    <div className="space-y-1">
                        <p className="text-zinc-400 text-[9px] uppercase font-bold tracking-[0.2em]">Want to Sell?</p>
                        <h2 className="text-xl md:text-2xl font-black italic tracking-tighter uppercase whitespace-nowrap">Start <span className="text-[#FF6200]">Selling</span></h2>
                    </div>
                    ...
                    >
                        Register Now <ArrowRight className="ml-3 h-4 w-4 group-hover:translate-x-1 transition-transform" />
                    </Button>
                </div>
                ...
                <div className="flex flex-col items-center gap-3">
                    ...
                    <div className="text-center">
                        <p className="text-[8px] font-black uppercase tracking-widest text-[#FF6200] mb-0.5">Scan to Sign Up</p>
                        <p className="text-[8px] font-medium text-zinc-500 uppercase tracking-widest max-w-[120px] leading-tight opacity-50">Open on your phone</p>
                    </div>
                </div>
            </div>
            ...
            <div className="relative z-10 opacity-20 flex items-center gap-4">
                ...
                <span className="text-[8px] font-black uppercase tracking-[1em] text-zinc-500">MarketBridge v1.0</span>
                <div className="h-px w-8 bg-zinc-500" />
            </div>
        </div>
    );
