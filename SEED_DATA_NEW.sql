...
-- This creates a test user first, then adds listings

-- Step 1: Create a test user directly in public.users
-- Note: This bypasses auth.users, so this user won't be able to log in
-- You'll need to sign up properly through the app for a real user
